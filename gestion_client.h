...
#include <QList>
#include <QSqlQuery>
/*#include <opencv2/opencv.hpp>  // ⭐ AJOUTER
...
public:
    ...
    /*static bool validerVisageHumain(const QString &cheminPhoto, QString &erreurMessage);
    static void verifierInstallationOpenCV();*/
    static QString genererNomCourtPhoto(const QString &cheminOriginal);
    static QString copierPhotoVersDossier(const QString &sourcePath);
