...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(958, 647);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        stackedWidget = new QStackedWidget(centralwidget);
        stackedWidget->setObjectName("stackedWidget");
        stackedWidget->setGeometry(QRect(-21, -1, 1501, 821));
...
"}"));
        ...
        lineEditPhoto = new QLineEdit(frameFicheClient_3);
        lineEditPhoto->setObjectName("lineEditPhoto");
        lineEditPhoto->setGeometry(QRect(600, 200, 113, 28));
...
""));
        ...
        btnStatistiques = new QPushButton(frame_10);
        btnStatistiques->setObjectName("btnStatistiques");
        btnStatistiques->setStyleSheet(QString::fromUtf8("background-color:#a55eea;color:white;font-weight:bold;border-radius:10px;padding:8px 16px;font-size:14px;"));

        searchLayout_4->addWidget(btnStatistiques);

        btnPDF = new QPushButton(frame_10);
        btnPDF->setObjectName("btnPDF");
        btnPDF->setStyleSheet(QString::fromUtf8("background-color:#a55eea;color:white;font-weight:bold;border-radius:10px;padding:8px 16px;font-size:14px;"));

        searchLayout_4->addWidget(btnPDF);


        verticalLayout_4->addLayout(searchLayout_4);

        Modifier = new QPushButton(frame_10);
        Modifier->setObjectName("Modifier");
        Modifier->setStyleSheet(QString::fromUtf8("background-color:#a55eea;color:white;font-weight:bold;border-radius:10px;padding:8px 16px;font-size:14px;"));

        verticalLayout_4->addWidget(Modifier);

        delete_2 = new QPushButton(frame_10);
...
"border-color: rgb(0, 0, 255);"));
        ...
        frameFicheClient_4->setGeometry(QRect(150, 30, 1081, 631));
...
"border-color: rgb(0, 0, 127);"));
        ...
        nom_entreprise = new QLineEdit(frameFicheClient_4);
        nom_entreprise->setObjectName("nom_entreprise");
        nom_entreprise->setGeometry(QRect(230, 210, 251, 26));
        nom_entreprise->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        tel = new QLineEdit(frameFicheClient_4);
        tel->setObjectName("tel");
        tel->setGeometry(QRect(230, 260, 251, 26));
        tel->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        adresse = new QLineEdit(frameFicheClient_4);
        adresse->setObjectName("adresse");
        adresse->setGeometry(QRect(230, 370, 251, 26));
        adresse->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        id = new QLineEdit(frameFicheClient_4);
        id->setObjectName("id");
        id->setGeometry(QRect(230, 160, 251, 26));
        ...
        email_entreprise = new QLineEdit(frameFicheClient_4);
        email_entreprise->setObjectName("email_entreprise");
        email_entreprise->setGeometry(QRect(230, 320, 251, 26));
        email_entreprise->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        ...
        dest = new QLineEdit(frameFicheClient_4);
        dest->setObjectName("dest");
        dest->setGeometry(QRect(580, 150, 171, 26));
        dest->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        contenu = new QLineEdit(frameFicheClient_4);
        contenu->setObjectName("contenu");
        contenu->setGeometry(QRect(580, 190, 171, 101));
        contenu->setStyleSheet(QString::fromUtf8("color: rgb(0, 0, 0);"));
        Send_mail = new QPushButton(frameFicheClient_4);
        Send_mail->setObjectName("Send_mail");
        Send_mail->setGeometry(QRect(610, 310, 121, 41));
...
""));
        ...
        tablePersonnel_3->setHorizontalHeaderItem(0, __qtablewidgetitem79);
        QTableWidgetItem *__qtablewidgetitem80 = new QTableWidgetItem();
        tablePersonnel_3->setHorizontalHeaderItem(1, __qtablewidgetitem80);
        QTableWidgetItem *__qtablewidgetitem81 = new QTableWidgetItem();
        tablePersonnel_3->setHorizontalHeaderItem(2, __qtablewidgetitem81);
        QTableWidgetItem *__qtablewidgetitem82 = new QTableWidgetItem();
        tablePersonnel_3->setHorizontalHeaderItem(3, __qtablewidgetitem82);
        QTableWidgetItem *__qtablewidgetitem83 = new QTableWidgetItem();
        tablePersonnel_3->setHorizontalHeaderItem(4, __qtablewidgetitem83);
        QTableWidgetItem *__qtablewidgetitem84 = new QTableWidgetItem();
        tablePersonnel_3->setHorizontalHeaderItem(5, __qtablewidgetitem84);
        QTableWidgetItem *__qtablewidgetitem85 = new QTableWidgetItem();
        tablePersonnel_3->setHorizontalHeaderItem(6, __qtablewidgetitem85);
        QTableWidgetItem *__qtablewidgetitem86 = new QTableWidgetItem();
        tablePersonnel_3->setHorizontalHeaderItem(7, __qtablewidgetitem86);
        QTableWidgetItem *__qtablewidgetitem87 = new QTableWidgetItem();
        tablePersonnel_3->setHorizontalHeaderItem(8, __qtablewidgetitem87);
        if (tablePersonnel_3->rowCount() < 8)
            tablePersonnel_3->setRowCount(8);
        QTableWidgetItem *__qtablewidgetitem88 = new QTableWidgetItem();
        tablePersonnel_3->setItem(0, 0, __qtablewidgetitem88);
        QTableWidgetItem *__qtablewidgetitem89 = new QTableWidgetItem();
        tablePersonnel_3->setItem(0, 1, __qtablewidgetitem89);
        QTableWidgetItem *__qtablewidgetitem90 = new QTableWidgetItem();
        tablePersonnel_3->setItem(0, 2, __qtablewidgetitem90);
        QTableWidgetItem *__qtablewidgetitem91 = new QTableWidgetItem();
        tablePersonnel_3->setItem(0, 3, __qtablewidgetitem91);
        QTableWidgetItem *__qtablewidgetitem92 = new QTableWidgetItem();
        tablePersonnel_3->setItem(0, 8, __qtablewidgetitem92);
        QTableWidgetItem *__qtablewidgetitem93 = new QTableWidgetItem();
        tablePersonnel_3->setItem(1, 0, __qtablewidgetitem93);
        QTableWidgetItem *__qtablewidgetitem94 = new QTableWidgetItem();
        tablePersonnel_3->setItem(1, 1, __qtablewidgetitem94);
        QTableWidgetItem *__qtablewidgetitem95 = new QTableWidgetItem();
        tablePersonnel_3->setItem(1, 2, __qtablewidgetitem95);
        QTableWidgetItem *__qtablewidgetitem96 = new QTableWidgetItem();
        tablePersonnel_3->setItem(1, 3, __qtablewidgetitem96);
        QTableWidgetItem *__qtablewidgetitem97 = new QTableWidgetItem();
        tablePersonnel_3->setItem(2, 0, __qtablewidgetitem97);
        QTableWidgetItem *__qtablewidgetitem98 = new QTableWidgetItem();
        tablePersonnel_3->setItem(2, 1, __qtablewidgetitem98);
        QTableWidgetItem *__qtablewidgetitem99 = new QTableWidgetItem();
        tablePersonnel_3->setItem(2, 2, __qtablewidgetitem99);
        QTableWidgetItem *__qtablewidgetitem100 = new QTableWidgetItem();
        tablePersonnel_3->setItem(2, 3, __qtablewidgetitem100);
...
"}"));
        ...
        frame_6->setGeometry(QRect(-20, 60, 191, 751));
...
"}"));
        ...
        menubar->setGeometry(QRect(0, 0, 958, 18));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_8->setText(QCoreApplication::translate("MainWindow", "R\303\264le", nullptr));
        ...
        searchLineEdit_4->setText(QString());
        ...
        comboProfession_4->setItemText(0, QCoreApplication::translate("MainWindow", "id", nullptr));
        comboProfession_4->setItemText(1, QCoreApplication::translate("MainWindow", "nom", nullptr));
        ...
        btnPDF->setText(QCoreApplication::translate("MainWindow", "Export PDF", nullptr));
        Modifier->setText(QCoreApplication::translate("MainWindow", "Modifier", nullptr));
        delete_2->setStyleSheet(QCoreApplication::translate("MainWindow", "background-color:#a55eea;color:white;font-weight:bold;border-radius:10px;padding:8px 16px;font-size:14px;", nullptr));
        ...
        nom_entreprise->setText(QString());
        nom_entreprise->setPlaceholderText(QCoreApplication::translate("MainWindow", "Nom de L'Entreprise", nullptr));
        tel->setText(QString());
        tel->setPlaceholderText(QCoreApplication::translate("MainWindow", "Telephone", nullptr));
        adresse->setText(QString());
        adresse->setPlaceholderText(QCoreApplication::translate("MainWindow", "Adresse", nullptr));
        id->setText(QString());
        id->setPlaceholderText(QCoreApplication::translate("MainWindow", "ID Fournisseur", nullptr));
        ...
        email_entreprise->setText(QString());
        email_entreprise->setPlaceholderText(QCoreApplication::translate("MainWindow", "Email", nullptr));
        ...
        contenu->setText(QString());
        contenu->setPlaceholderText(QCoreApplication::translate("MainWindow", "xontenu du mail", nullptr));
        Send_mail->setStyleSheet(QCoreApplication::translate("MainWindow", "background-color:#a55eea;color:white;font-weight:bold;border-radius:10px;padding:8px 16px;font-size:14px;", nullptr));
        Send_mail->setText(QCoreApplication::translate("MainWindow", "Envoyer Mail", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem51 = tablePersonnel_3->horizontalHeaderItem(0);
        ___qtablewidgetitem51->setText(QCoreApplication::translate("MainWindow", "ID Produit", nullptr));
        QTableWidgetItem *___qtablewidgetitem52 = tablePersonnel_3->horizontalHeaderItem(1);
        ___qtablewidgetitem52->setText(QCoreApplication::translate("MainWindow", "Marque", nullptr));
        QTableWidgetItem *___qtablewidgetitem53 = tablePersonnel_3->horizontalHeaderItem(2);
        ___qtablewidgetitem53->setText(QCoreApplication::translate("MainWindow", "Mod\303\251le", nullptr));
        QTableWidgetItem *___qtablewidgetitem54 = tablePersonnel_3->horizontalHeaderItem(3);
        ___qtablewidgetitem54->setText(QCoreApplication::translate("MainWindow", "Type", nullptr));
        QTableWidgetItem *___qtablewidgetitem55 = tablePersonnel_3->horizontalHeaderItem(4);
        ___qtablewidgetitem55->setText(QCoreApplication::translate("MainWindow", "Couleur", nullptr));
        QTableWidgetItem *___qtablewidgetitem56 = tablePersonnel_3->horizontalHeaderItem(5);
        ___qtablewidgetitem56->setText(QCoreApplication::translate("MainWindow", "Prix", nullptr));
        QTableWidgetItem *___qtablewidgetitem57 = tablePersonnel_3->horizontalHeaderItem(6);
        ___qtablewidgetitem57->setText(QCoreApplication::translate("MainWindow", "Quantit\303\251", nullptr));
        QTableWidgetItem *___qtablewidgetitem58 = tablePersonnel_3->horizontalHeaderItem(7);
        ___qtablewidgetitem58->setText(QCoreApplication::translate("MainWindow", "Date d'ajout", nullptr));
        QTableWidgetItem *___qtablewidgetitem59 = tablePersonnel_3->horizontalHeaderItem(8);
        ___qtablewidgetitem59->setText(QCoreApplication::translate("MainWindow", "Actions", nullptr));

        const bool __sortingEnabled3 = tablePersonnel_3->isSortingEnabled();
        tablePersonnel_3->setSortingEnabled(false);
        tablePersonnel_3->setSortingEnabled(__sortingEnabled3);
        ...
        ___qtablewidgetitem60->setText(QCoreApplication::translate("MainWindow", "ID Produit", nullptr));

        const bool __sortingEnabled4 = tableWidget->isSortingEnabled();
        tableWidget->setSortingEnabled(false);
        QTableWidgetItem *___qtablewidgetitem61 = tableWidget->item(0, 0);
        ___qtablewidgetitem61->setText(QCoreApplication::translate("MainWindow", "2312", nullptr));
        QTableWidgetItem *___qtablewidgetitem62 = tableWidget->item(1, 0);
        ___qtablewidgetitem62->setText(QCoreApplication::translate("MainWindow", "6574", nullptr));
        QTableWidgetItem *___qtablewidgetitem63 = tableWidget->item(2, 0);
        ___qtablewidgetitem63->setText(QCoreApplication::translate("MainWindow", "7456", nullptr));
        QTableWidgetItem *___qtablewidgetitem64 = tableWidget->item(3, 0);
        ___qtablewidgetitem64->setText(QCoreApplication::translate("MainWindow", "0879", nullptr));
        QTableWidgetItem *___qtablewidgetitem65 = tableWidget->item(4, 0);
        ___qtablewidgetitem65->setText(QCoreApplication::translate("MainWindow", "2313", nullptr));
